...
# ============================================
# THE OLD SHINOBI - Script de Instalação
# ============================================
...
case $OPTION in
    1)
        ...
        echo "   - Execute o SQL"
        echo ""
        echo "2. Inicie a aplicação com o script:"
        echo "   ${CYAN}./start.sh${NC}"
        echo ""
        echo "3. Ou inicie manualmente:"
        echo "   Backend (terminal 1): ${CYAN}cd revista-cms-api && npm run dev${NC}"
        echo "   Frontend (terminal 2): ${CYAN}cd revista-portal && npm run dev${NC}"
        echo ""
        ...
        echo "   ${CYAN}cd revista-cms-api && npm run create-admin${NC}"
        echo ""
        echo -e "${YELLOW}💡 Dica: Leia o arquivo docs/INSTALL.md para mais informações${NC}"
        echo ""
        ;;
